...
public static class SealedFgaCheckDispatch {
    ...
    public static async Task<bool?> TryCheckByTypeNameAsync(
        ...
        CancellationToken cancellationToken = default
            ...
            "secret" => await svc.CheckAsync(user, TestApp.SecretEntityIdRelations.FromOpenFgaString(relation), TestApp.SecretEntityId.Parse(objectId), queryOptions, cancellationToken),
