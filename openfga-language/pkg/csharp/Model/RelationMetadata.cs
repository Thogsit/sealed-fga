...
namespace OpenFga.Language.Model {
    ...
    public class RelationMetadata : IEquatable<RelationMetadata>, IValidatableObject {
        /// <summary>
        ...
        public RelationMetadata(List<RelationReference> directlyRelatedUserTypes = null, string module = null, SourceInfo sourceInfo = null) {
