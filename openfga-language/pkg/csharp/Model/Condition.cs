...
namespace OpenFga.Language.Model {
    ...
    public class Condition : IEquatable<Condition>, IValidatableObject {
        /// <summary>
        ...
        public Condition(string name = null, string expression = null, Dictionary<string, ConditionParamTypeRef> parameters = null, ConditionMetadata metadata = null) {
