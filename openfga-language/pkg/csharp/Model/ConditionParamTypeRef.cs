...
namespace OpenFga.Language.Model {
    ...
    public class ConditionParamTypeRef : IEquatable<ConditionParamTypeRef>, IValidatableObject {
        ...
        public ConditionParamTypeRef(TypeName typeName = default, List<ConditionParamTypeRef> genericTypes = null) {
            TypeName = typeName;
